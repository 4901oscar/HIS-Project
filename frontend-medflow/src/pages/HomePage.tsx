        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 hover:shadow-xl transition-shadow">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-medin-cyan bg-opacity-10 rounded-full flex items-center justify-center mb-4 md:mb-6">
            ...
            {/* Médicos */}
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 hover:shadow-xl transition-shadow">
              <div className="w-12 h-12 md:w-16 md:h-16 bg-medin-navy bg-opacity-10 rounded-full flex items-center justify-center mb-4 md:mb-6">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-medin-navy mb-2 md:mb-3">Médicos</h3>
              <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">
                Gestiona consultas, triaje y expedientes médicos electrónicos
              </p>
              <a
                href="/login"
                className="inline-block px-5 md:px-6 py-2 bg-medin-navy text-white rounded-full font-semibold hover:bg-medin-navy-dark transition-colors text-sm md:text-base"
              >
                Acceder
              </a>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-medin-navy mb-2 md:mb-3">Administración</h3>
              <p className="text-sm md:text-base text-gray-600 mb-4 md:mb-6">
                Control de facturación, caja y gestión hospitalaria integral
              </p>
              <a
                href="/login"
                className="inline-block px-5 md:px-6 py-2 bg-medin-blue text-medin-navy rounded-full font-semibold hover:bg-medin-blue-light transition-colors text-sm md:text-base"
