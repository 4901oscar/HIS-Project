...
- [ ] 2. Domain model - Entities
  ...
  - [ ] 2.4 Implement Appointment domain entity
  ...
  - [ ] 2.5 Implement Consultation domain entity
  ...
  - [ ] 2.6 Implement Prescription domain entity
  ...
  - [ ] 2.7 Implement LabOrder domain entity
  ...
  - [ ] 2.8 Implement ManchesterMotif and ManchesterDiscriminator domain entities
...
- [ ] 3. Domain ports (interfaces)
  - [ ] 3.1 Create input ports (use case interfaces)
  ...
  - [ ] 3.2 Create output ports (repository and client interfaces)
...
- [ ] 4. Domain services (business logic - pure functions ideal for PBT)
  - [ ] 4.1 Implement TriageEngine domain service
  ...
  - [ ]* 4.2 Write property test: Manchester Algorithm Selects Maximum Priority
  ...
  - [ ]* 4.3 Write property test: Manchester Algorithm is Deterministic
  ...
  - [ ] 4.4 Implement VitalSignsRecorder domain service
  ...
  - [ ]* 4.5 Write property test: BMI Calculation is Correct
    - **Property 3: BMI Calculation is Correct**
    - **Validates: Requirements 2.3**
    - Generate random valid weight/height pairs, verify BMI = weight / (height_m)^2
    - _Requirements: Requirement 2_

  - [ ]* 4.6 Write property test: Vital Signs Validation Respects Physiological Ranges
  ...
  - [ ] 4.7 Implement AppointmentManager domain service
  ...
  - [ ]* 4.8 Write property test: Daily Slots Generation Produces Exactly 18 Slots
  ...
  - [ ]* 4.9 Write property test: Appointment State Transitions are Valid
  ...
  - [ ] 4.10 Implement ConsultationManager domain service
    - Implement registerConsultation() method
    - Complete associated appointment if appointmentId provided
    - _Requirements: Requirement 4_

  - [ ] 4.11 Implement PrescriptionGenerator domain service
  ...
  - [ ]* 4.12 Write property test: Prescription Codes are Unique and Well-Formed
  ...
  - [ ]* 4.13 Write property test: Prescription Notification Failures Do Not Fail Transaction
  ...
  - [ ] 4.14 Implement LabOrderGenerator domain service
    - Implement generateLabOrder() method
    - Implement generateUniqueCode() - 8-char alphanumeric using SecureRandom
    - Notify LabServiceClient asynchronously (catch and log failures, don't throw)
    - _Requirements: Requirement 6_

  - [ ]* 4.15 Write property test: Lab Order Codes are Unique and Well-Formed
  ...
  - [ ]* 4.16 Write property test: Lab Order Notification Failures Do Not Fail Transaction
  ...
  - [ ] 4.17 Implement MedicalHistoryAggregator domain service
  ...
  - [ ]* 4.18 Write property test: Patients Can Only Access Their Own Medical History
  ...
  - [ ]* 4.19 Write property test: Consultations Ordered by Date Descending
...
- [ ] 6. Application layer - Use case implementations
  - [ ] 6.1 Implement PermissionValidator application service
  ...
  - [ ] 6.2 Implement PerformTriageUseCaseImpl
...
- [ ] 7. Infrastructure - Persistence adapter (JPA)
  - [ ] 7.1 Create JPA entities
  ...
  - [ ] 7.2 Create JPA Spring Data repositories
  ...
  - [ ] 7.3 Create repository adapter implementations
...
- [ ] 8. Infrastructure - Redis cache adapter
  - [ ] 8.1 Implement RedisAppointmentSlotCache
...
- [ ] 9. Infrastructure - HTTP client adapters (Feign)
  - [ ] 9.1 Implement PatientServiceClientAdapter
  ...
  - [ ] 9.2 Implement PharmacyServiceClientAdapter
  ...
  - [ ] 9.3 Implement LabServiceClientAdapter
  ...
  - [ ]* 9.4 Write integration tests for HTTP clients with WireMock
    ...
    - _Requirements: Requirements 5, 6, 10_

- [ ] 10. Infrastructure - REST adapter (Controllers and DTOs)
  - [ ] 10.1 Create request DTOs with validation annotations
...
- [ ] 12. Database schema and migration
  - [ ] 12.1 Create Flyway migration script V1__create_clinical_schema.sql
  ...
  - [ ] 12.2 Create seed data migration V2__seed_manchester_catalog.sql
...
- [ ] 14. Application main class and configuration
  - [ ] 14.1 Create ClinicalServiceApplication main class
